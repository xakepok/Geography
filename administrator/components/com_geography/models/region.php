...
class GeographyModelRegion extends AdminModel {
    public function getTable($name = 'Regions', $prefix = 'TableGeography', $options = array())
    {
    ...
    public function getForm($data = array(), $loadData = true)
    {
        ...
        if ($id != 0 && (!$user->authorise('core.edit.state', $this->option . '.region.' . (int) $id))
